  ...
  module V1
    ...
    private
      ...
      def all
        ...
        records = Rails.cache.fetch(cache_key([:data_time, @date_range]), expires_in: CACHE_TIME) do
        ...
        result = Rails.cache.fetch(cache_key([:data_series, @date_range]), expires_in: CACHE_TIME) do
          {
